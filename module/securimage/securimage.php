...
class Securimage {
	...
	*/
	...
	function Securimage()
	{
		...
		$this->perturbation       = 0.55;
		$this->iscale             = 5;
		$this->text_angle_minimum = 0;
		$this->text_angle_maximum = 15;
		//$this->ttf_file      = 'HP_PSG.ttf';
		$this->ttf_file      = 'module/securimage/HP_PSG.ttf';
		//$this->ttf_file      = 'module/securimage/28_days_later.ttf';

		$this->image_bg_color   = new Securimage_Color(0xff, 0xff, 0xff);
		$this->text_color       = new Securimage_Color(0x1b, 0x8a, 0xba);
		...
		//$this->num_lines            = 3;//14698D
		//$this->line_color           = new Securimage_Color(0x14, 0x69, 0x8d);
